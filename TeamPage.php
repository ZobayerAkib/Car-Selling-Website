          ...
          <div class="card-footer">
            <div class="row justify-content-center">
              <div class="col-3 d-flex justify-content-center">
                <a target="_blank" href="<?php echo $products['link1'];?>"><span style="font-size: 25px;"><i
                      class="fab fa-facebook"></i></span></a>
              </div>
              <div class="col-3 d-flex justify-content-center ">
                <a target="_blank"
                  href="<?php echo $products['link2'];?>"><span
                    style="font-size: 25px;"><i class="fab fa-linkedin"></i></span></a>
              </div>
            </div>
          </div>
        </div>
